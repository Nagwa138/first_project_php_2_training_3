        ...
        <div class="col-lg-6 align-self-center">
          <div class="caption header-text">
            ...
            <div class="search-input">
              <form id="search" action="{{url('users/store')}}" method="post">
                @csrf
                <input type="text" placeholder="Type user name" name="name" onkeypress="handle" />
                <input type="text" placeholder="Type user email" name="email" onkeypress="handle" />
                <input type="text" placeholder="Type password" id='searchText' name="password" onkeypress="handle" />
                <input type="submit" value="Create" style="background-color:green">
              </form>
            </div>
          </div>
        </div>
